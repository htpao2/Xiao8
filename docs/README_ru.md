...
<tr>
<td align="center">🔌<br><b>Экосистема плагинов</b><br>Полный SDK плагинов для пользовательских расширений</td>
<td align="center">🌐<br><b>14+ ИИ-провайдеров</b><br>OpenAI / Gemini / Qwen / DeepSeek и другие, с бесплатными моделями из коробки</td>
<td align="center">💬<br><b>Проактивный чат</b><br>Круглосуточное осознание: понимание экрана, тренды соцсетей, персональные ленты, новости — она сама начинает разговор с вами</td>
...
**Примечание**: Текущее решение для Docker-развёртывания предоставлено [**HINS**](https://home.hinswu.top)
...
> Получение *Alibaba Cloud API*: Зарегистрируйтесь на платформе Bailian от Alibaba Cloud [официальный сайт](https://bailian.console.aliyun.com/). Новые пользователи получают значительные бесплатные кредиты после верификации. После регистрации перейдите в [консоль](https://bailian.console.aliyun.com/api-key?tab=model#/api-key) для получения API Key.
